...
function App() {
  return (
    <div className="flex justify-center bg-white w-full xl:p-16">
        <div id="texto" className="font-Nunito 2xl:w-1/2 p-20 2xl:pr-72 animate-slideRT">
        ...
        <div id="img" className="2xl:block sm:hidden">
