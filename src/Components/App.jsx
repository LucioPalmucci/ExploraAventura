...
function App() {
  return (
    <div className="flex justify-center bg-white w-full p-16">
        <div id="texto" className="font-Nunito w-1/2 p-20 pr-72">
            ...
            <button className="text-base p-4 pl-8 pr-8 rounded-3xl bg-red-500 text-white hover:bg-violet-950">¡Descarga la app!</button>
        </div>
        <div id="img">
